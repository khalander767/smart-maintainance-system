...
import { User, Bell, Lock, Home } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-start">
          ...
          <motion.div variants={section} initial="hidden" animate="show" transition={{ delay: 0.05 }}
            ...
            <div className="flex items-center gap-4 mb-5 pb-5 border-b border-gray-100">
              ...
              <div>
                ...
                <span className="text-xs bg-purple-50 text-purple-600 border border-purple-200 px-2 py-0.5 rounded-lg mt-1 inline-block">
                  Resident
                </span>
              </div>
            </div>
          ...
          <motion.div variants={section} initial="hidden" animate="show" transition={{ delay: 0.1 }}
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="font-semibold text-gray-800">Apartment Info</h2>
            </div>
            <div className="bg-gray-50 rounded-xl p-4 space-y-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-700 font-medium">Resident</span>
              </div>
            </div>
          </motion.div>
          </div>
          ...
          <motion.div variants={section} initial="hidden" animate="show" transition={{ delay: 0.15 }}
            ...
            <div className="space-y-4">
              {[
                { label: "Push Notifications",  sub: "Get notified when your complaint is updated", val: notifications, fn: setNotifications },
                { label: "Status Updates",       sub: "Alert when technician is assigned or resolves",  val: statusUpdates,  fn: setStatusUpdates },
              ].map((item) => (
